...
const Signup = () => {
  ...
  const { signup, loginAnonymously, loginWithGoogle } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-off-white px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 shadow-sm border border-gray-100">
        <h2 className="text-2xl font-serif text-center mb-8">Sign Up</h2>
        ...
        <button
          ...
          className="w-full mt-4 bg-white text-black border border-black py-3 uppercase tracking-widest hover:bg-gray-50 transition-colors duration-300 text-sm flex items-center justify-center gap-2"
        >
